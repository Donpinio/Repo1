 ...
 * @author Piotr.Piróg
 */
public class MDUserApplicationForm extends JPanel {
    
    public MDUserApplicationForm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.beansbinding.ELProperty eLProperty = org.jdesktop.beansbinding.ELProperty.create("${selectedElement.applicationCollection}");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == newButton) {
                MDUserApplicationForm.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                MDUserApplicationForm.this.deleteButtonActionPerformed(evt);
            }
            else if (evt.getSource() == saveButton) {
                MDUserApplicationForm.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                MDUserApplicationForm.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteDetailButton) {
                MDUserApplicationForm.this.deleteDetailButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newDetailButton) {
                MDUserApplicationForm.this.newDetailButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteDetailButtonActionPerformed
        ...
        abimanager.User u = list.get(masterTable.convertRowIndexToModel(index));
        Collection<abimanager.Application> as = u.getApplicationCollection();
        int[] selected = detailTable.getSelectedRows();
        List<abimanager.Application> toRemove = new ArrayList<abimanager.Application>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            selected[idx] = detailTable.convertRowIndexToModel(selected[idx]);
            int count = 0;
            Iterator<abimanager.Application> iter = as.iterator();
            while (count++ < selected[idx]) {
                iter.next();
            }
            abimanager.Application a = iter.next();
            toRemove.add(a);
    ...
    private void newDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newDetailButtonActionPerformed
        ...
        Collection<abimanager.Application> as = u.getApplicationCollection();
        if (as == null) {
            as = new LinkedList<abimanager.Application>();
            u.setApplicationCollection((List) as);
        }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MDUserApplicationForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new MDUserApplicationForm());
